...
with tab1:
    ...
    with c2:
        if submitted:
            ...
            with v2:
                gauge = {"series":[{"type":"gauge","startAngle":220,"endAngle":-40,"min":0,"max":100,"pointer":{"length":"55%","width":4,"itemStyle":{"color":color}},"axisLine":{"lineStyle":{"width":10,"color":[[0.3,"#34D399"],[0.6,"#FBBF24"],[0.85,"#FB923C"],[1,"#FB7185"]]}},"axisTick":{"show":False},"splitLine":{"length":8,"lineStyle":{"color":"#3F3F46"}},"axisLabel":{"distance":16,"color":"#71717A","fontSize":9},"detail":{"valueAnimation":True,"formatter":"{value}%","color":color,"fontSize":20,"fontFamily":"JetBrains Mono","offsetCenter":[0,"70%"]},"data":[{"value":round(prob*100,1),"name":"Fraud score"}],"title":{"offsetCenter":[0,"90%"],"color":"#71717A","fontSize":10}}]}
